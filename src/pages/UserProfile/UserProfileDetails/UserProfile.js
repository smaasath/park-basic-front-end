...
const UserProfile = () => {
  ...
  const handleSubmitPassword = () => {
    ...
    const conPassValidation =
      inputPassword.password === inputPassword.conpassword;
        ...
        updateUserDetails(
          ...
          (res) => {
            ...
            if (res?.status == 200) {
              ...
              setloading(false);
              toast.error("Enter your correct old password", {
                autoClose: 1000,
              });
            } else {
              setloading(false);
      ...
      <div
        className={
          loading
            ...
            : "container bg-white rounded mt-5 mb-5"
        }
      >
        {loading ? (
          ...
          <div className="container" style={{ backgroundColor: "#EDEDED" }}>
            ...
            {userData?.reserver != null ? (
              <div
                className="first-form d-flex flex-column"
                style={{ backgroundColor: "#EDEDED" }}
              >
                <div className="col-md-8 d-md-flex container-fluid  justify-content-between">
                ...
                <div className="mt-5 d-flex justify-content-end gap-5 align-content-center align-items-center">
                  <div>
                    <button
            ...
            <div className="pb-5 pt-2 mt-2.2">
              <div className="second-form">
                ...
                {editPass ? (
                  <div className="d-flex flex-column align-items-center">
                    ...
                    <div className="mt-3 d-flex container justify-content-end gap-5 align-items-end">
                      <button
                        type="button"
              ...
              <div className="text-end mt-5 container">
                <CommonButton ButtonText="Logout" onclick={() => logout()} />
              </div>
            </div>
          </div>
        )}
